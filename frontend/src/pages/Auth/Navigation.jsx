    ...
    >
      <div className="flex flex-col justify-center space-y-4">
        ...
        >
          ...
          {cartItems.length > 0 && (
            <span>
              <span className="px-1 py-0 text-white text-sm bg-pink-500 rounded-full">
      ...
      <div className="relative">
        <button
          ...
          className="cursor-pointer flex items-center text-gray-800 focus:ouline-none"
        >
          {userInfo ? (
        ...
        {dropdownOpen && userInfo && (
          <ul
            className={`absolute right-0 bottom-0 ml-14 space-y-2 bg-gray-700 text-white $userInfo.${
